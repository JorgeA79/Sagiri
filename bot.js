...
.setThumbnail("https://cdn.discordapp.com/attachments/405118984451653633/405149226604167179/91380.png")
  ...
  .addField("Audio Commands", "\`play <URL>\`,\`join\`,\`leave\`,\`topsongs\`,\`top play <Number of the song>\`", true)
...
client.on('message', message => {
	...
	const args = "https://www.youtube.com/watch?v=XMXgHfHxKVM";
	   if(text == "1"){
		args = "https://www.youtube.com/watch?v=qpgTC9MDx1o&index=9&list=RDGMEMQ1dJ7wXfLlqCjwV0xfSNbAVMfLexgOxsZu0";   
	   }
